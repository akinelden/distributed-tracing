...
class Server {
  public:
    ...
    Server& Post(const char* pattern,
                 size_t pattern_len,
    ...
    Server& Delete(const char* pattern,
                   size_t pattern_len,
                   HandlerWithContentReader handler);
    ...
    bool set_mount_point(const char* mount_point,
                         const char* dir,
  ...
  private:
    ...
    bool
    read_content_with_content_receiver(Stream& strm,
                                       Request& req,
                                       Response& res,
                                       ContentReceiver receiver,
...
class ClientImpl {
  public:
    ...
    Result Post(const char* path,
                ...
                const char* content_type);
    Result
    Post(const char* path, const std::string& body, const char* content_type);
    Result Post(const char* path,
                const Headers& headers,
    ...
    Result Put(const char* path,
               ...
               const char* content_type);
    Result
    Put(const char* path, const std::string& body, const char* content_type);
    Result Put(const char* path,
               const Headers& headers,
               const std::string& body,
               const char* content_type);
    ...
    Result Patch(const char* path,
                 ...
                 const char* content_type);
    Result
    Patch(const char* path, const std::string& body, const char* content_type);
    Result Patch(const char* path,
                 const Headers& headers,
                 const std::string& body,
                 const char* content_type);
    ...
    Result Delete(const char* path,
                  ...
                  const char* content_type);
    Result
    Delete(const char* path, const std::string& body, const char* content_type);
    Result Delete(const char* path,
                  const Headers& headers,
                  const std::string& body,
                  const char* content_type);
  ...
  protected:
    ...
    bool
    write_content_with_provider(Stream& strm, const Request& req, Error& error);
...
inline void parse_query_text(const std::string& s, Params& params)
{
    ...
    split(
        s.data(), s.data() + s.size(), '&', [&](const char* b, const char* e) {
            std::string kv(b, e);
...
class MultipartFormDataParser {
  ...
  private:
    ...
    bool
    start_with(const std::string& a, size_t off, const std::string& b) const
    {
...
{
    return message_digest<MD5_CTX>(
        s, MD5_Init, MD5_Update, MD5_Final, MD5_DIGEST_LENGTH);
}

inline std::string SHA_256(const std::string& s)
{
    return message_digest<SHA256_CTX>(
        s, SHA256_Init, SHA256_Update, SHA256_Final, SHA256_DIGEST_LENGTH);
}

inline std::string SHA_512(const std::string& s)
{
    return message_digest<SHA512_CTX>(
        s, SHA512_Init, SHA512_Update, SHA512_Final, SHA512_DIGEST_LENGTH);
}
#endif
...
inline void
Response::set_content_provider(size_t in_length,
                               const char* content_type,
                               ContentProvider provider,
...
inline bool Server::set_mount_point(const char* mount_point,
                                    const char* dir,
                                    Headers headers)
{
